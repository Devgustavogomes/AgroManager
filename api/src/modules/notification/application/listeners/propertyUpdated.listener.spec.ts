...
import { PropertyUpdatedListener } from './propertyUpdated.listener';
...
describe('PropertyUpdatedListener', () => {
  ...
  it('Should handle property.updated event successfully', async () => {
    ...
    await listener.handlePropertyUpdatedEvent(payload);
